...
//   goroutine spawning for 10,000 jobs (see goperf.dev benchmarks) [web:3]
//
...
func (s *Server) worker(ctx context.Context, id int) {
	for {
		...
		case job, ok := <-s.queue:
			...
			// Cancellation propagates DOWN the tree automatically. [web:2]
			// =================================================================
			...
			// allocations—far faster than mutex-protected counters. [web:40]
			//
...
// a) Stop accepting new HTTP connections (srv.Shutdown)
